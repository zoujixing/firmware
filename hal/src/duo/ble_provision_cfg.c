...
{
	.device_name               = (uint8_t *)"BLE Provision",        /**< Local device name (NULL terminated) */
	...
	}                                                            /* MTU for AVRC browsing messages (minimum is 335 bytes, or 0 if AVRC browsing is not required) */
};
